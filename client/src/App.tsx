...
import SimpleFirebaseDebug from "@/pages/simple-firebase-debug";
  ...
  return (
    <Switch>
      ...
      <Route path="/auth-debug">
        <ErrorBoundary fallback={
          <div className="p-6 bg-red-50 text-red-800 rounded-md m-4">
            <h2 className="text-lg font-bold mb-2">Auth Debug Error Caught</h2>
            <p>Something went wrong in the auth debug page. Please check the console for errors.</p>
          </div>
        }>
          {React.createElement(React.lazy(() => import("@/pages/auth-page-debug")))}
        </ErrorBoundary>
      </Route>
      ...
      <Route path="/auth">
        <ErrorBoundary fallback={
          <div className="p-6 bg-red-50 text-red-800 rounded-md m-4">
            <h2 className="text-lg font-bold mb-2">Auth Page Error Caught</h2>
            <p>Something went wrong in the auth page. Please check the console for errors.</p>
          </div>
        }>
          {/* Use direct import instead of lazy loading to help with debugging */}
          <AuthPageLocal />
        </ErrorBoundary>
      </Route>
