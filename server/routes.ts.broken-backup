...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Static file serving removed to allow React Router to handle all routing
  // Set up the force-logout endpoint
  setupForceLogoutEndpoint(app);
  
  // All diagnostic/test routes removed to allow React Router to handle routing
  
  // All debug/test/HTML routes removed - React Router handles all routing
...
\`;
  ...
  // Static /static route removed to allow React Router to handle routing
  ...
  // Embed parent dashboard directly in the response
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Cricket Academy - Parent Dashboard</title>
    <style>
        body {
...
<body>
    <div class="header">
        <div class="nav-container">
            <div class="logo">Legacy <span class="highlight">Cricket Academy</span></div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="card">
                ...
                <p>24 practices attended</p>
            </div>
            
            <div class="card">
                <div class="accent purple"></div>
                <div class="card-title">Fitness Score</div>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <th style="text-align: left; padding: 12px 16px;">Title</th>
                ...
                <tbody>
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <td style="padding: 12px 16px;">Team Practice</td>
                        <td style="padding: 12px 16px;">May 20, 2025 • 16:00 - 18:00</td>
                        <td style="padding: 12px 16px;">Main Cricket Ground</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <td style="padding: 12px 16px;">Fitness Training</td>
                        <td style="padding: 12px 16px;">May 22, 2025 • 15:30 - 17:00</td>
                        <td style="padding: 12px 16px;">Academy Training Center</td>
                    </tr>
                    <tr>
                        <td style="padding: 12px 16px;">Practice Match</td>
                        <td style="padding: 12px 16px;">May 24, 2025 • 09:00 - 12:00</td>
                        <td style="padding: 12px 16px;">City Cricket Stadium</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div style="background-color: white; border-radius: 8px; padding: 20px;">
            ...
            <div style="margin-bottom: 20px;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                    <span>Batting Technique</span>
                    <span>85/100</span>
                </div>
                <div style="height: 8px; width: 100%; background-color: #e5e7eb; border-radius: 9999px;">
                    <div style="height: 100%; width: 85%; background-color: #3b82f6; border-radius: 9999px;"></div>
                </div>
            </div>
            
            <div style="margin-bottom: 20px;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                    <span>Bowling Accuracy</span>
                    <span>72/100</span>
                </div>
                <div style="height: 8px; width: 100%; background-color: #e5e7eb; border-radius: 9999px;">
                    <div style="height: 100%; width: 72%; background-color: #3b82f6; border-radius: 9999px;"></div>
                </div>
            </div>
            ...
            <div style="margin-bottom: 20px;">
                ...
                <div style="height: 8px; width: 100%; background-color: #e5e7eb; border-radius: 9999px;">
                    <div style="height: 100%; width: 80%; background-color: #3b82f6; border-radius: 9999px;"></div>
                </div>
            </div>
        </div>
    </div>
  ...
  app.get('/api/check-username', async (req, res) => {
    try {
      ...
      if (academyContext) {
        ...
        // Fix the academy-specific search by using the proper method
  ...
  // Coaches pending approval route removed - handled by React Router
